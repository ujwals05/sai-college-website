...
const StudentLifeLayout = () => {
    const navItems = [
        { path: "/student-life", label: "Overview", end: true },
        { path: "/student-life/anti-ragging", label: "Anti-Ragging" },
        { path: "/student-life/placement", label: "Placement Cell" },
        { path: "/student-life/alumni", label: "Alumni Network" },
    ];
        ...
        <div className="flex min-h-screen">
            ...
            <aside className="w-80 bg-white border-r border-gray-100 p-8 hidden lg:block overflow-y-auto">
                <div className="sticky top-24">
                    <p className="text-blue-600 font-black text-xs tracking-[0.3em] uppercase mb-4">Student Life</p>
                    <h2 className="font-black text-2xl mb-10 text-[#101828] tracking-tight">Support & Success</h2>
                    ...
                    <div className="mt-12 p-6 bg-blue-50 rounded-2xl border border-blue-100 mb-20">
                        <p className="text-[#101828] font-bold text-sm mb-2">Help Center</p>
                        <p className="text-gray-500 text-xs mb-4 leading-relaxed">Reach out to our student welfare officer for any assistance.</p>
